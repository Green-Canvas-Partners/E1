...
END_DATE_DATA_DOWNLOAD = '2024-12-20'
...
YEARSTOCKS={key: [] for key in [2022+1, 2023+1]}#2005+1, 2006+1, 2007+1, 2008+1,2009+1, 2010+1,2011+1, 2012+1, 2013+1, 2014+1,
...
STOCKS_DATA_RAW_PKL = '/mnt/spare8tb/all_dataframes_sequential.pkl'
...
SELECTED_TOP_VOL_STOCKS_MAKE_YS=[10, 20]#, 27, 35, 50, 75, 100, 125, 150, 200, 250, 300, 500
...
SELECTED_TOP_VOL_STOCKS_SENS=[10, 20]#75, 100, 125, 150, 200, 250, 300, 500
MOMENTUM_WINDOWS_SENS=[[30], [63]]#, [90], [126], [150], [200], [252], [504]
HALF_LIVES_SENS=[[30], [63]]#, [90], [126], [150], [200], [250]
SELECTED_N_STOCK_POSITIVE_SENS=[1,3]#16, 20, 25, 27, 30, 33, 36, 40, 50, 55, 60, 70, 80
SELECTED_N_STOCK_CHOSE_SENS=[1,2]#, 13, 15, 20, , 3, 5, 8, 10
...
# Selection criteria
SELECTED_TOP_VOL_STOCKS = 10
SELECTED_MOM_WINDOW = 30
SELECTED_HALF_LIFE_WINDOW = 30
SELECTED_N_STOCK_POSITIVE = 2
